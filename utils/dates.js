...
// آخر يوم فعلي من فترة الشهر — تاريخ "الاستحقاق" الحقيقي لتحصيل/تسليم أي شهر هو دائماً آخر يوم منه
// (وليس أول يوم من الشهر الذي يليه، رغم تساويهما زمنياً تقريباً): محمد لاحظ صراحةً أن عرض "1 يوليو"
// كتاريخ استحقاق "شهر 6" يبدو مربكاً (تاريخ يقع فعلياً في شهر آخر مختلف عن رقم الشهر المعروض) —
// الصيغة الصحيحة بصرياً ومنطقياً هي "30 يونيو" (آخر يوم من نفس الشهر المقصود). تُستخدَم في كل مكان
// يُعرض أو يُحسَب فيه تاريخ/عدّاد استحقاق شهر (بطاقات الأشهر، منتقي الرغبات، رسائل واتساب التحصيل
// والتسليم، عدّاد الأيام المتبقية بلوحة العضو) — عمود "تاريخ الشهر" بقاعدة البيانات يبقى يخزّن بداية
// الفترة فقط كما هو (بلا أي تعديل على قاعدة البيانات نفسها)، هذه الدالة تحويل عرض/حساب فقط.
